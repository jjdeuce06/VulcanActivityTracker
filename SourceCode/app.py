...
from server.api.dashboard_api import dashboard_api
...
app.register_blueprint(login_api, url_prefix="/login_api") #login api
app.register_blueprint(dashboard_api, url_prefix="/dashboard_api") #dash api
