...
<h2>🎯 Goals</h2>
<ul>
  <li>Goal 1 – Finalize Dashboard</li>
  <li>Goal 2 – Activity Page</li>
  <li>Goal 3 – Dashboard data to database/ tables</li>
  <li>Goal 4 - Login Bug Fix</li>
...
<h2>🔗 Links</h2>
<ul>
  <li><strong>PRs:</strong> 2 Merged (PR #19)</li>
  <li><strong>Tickets / Issues:</strong>
    <ul>
      <li>#14 – Activity Page</li>
    </ul>
  </li>
</ul>
</div>
